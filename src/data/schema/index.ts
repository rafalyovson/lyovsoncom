// user
export { users, userInsertSchema, userSelectSchema } from './user';
...
export {
  categoryPost,
  categoryPostSelectSchema,
  categoryPostInsertSchema,
} from './categoryPost';
export type { CategoryPost, NewCategoryPost } from './categoryPost';

// tagPost
export { tagPost, tagPostSelectSchema, tagPostInsertSchema } from './tagPost';
