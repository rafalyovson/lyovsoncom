...
export const metadata: Metadata = {
  ...
  keywords: ['subscription confirmed', 'newsletter', 'thank you', 'email updates'],
  alternates: {
    canonical: '/subscription-confirmed',
  },
  openGraph: {
    title: 'Subscription Confirmed - Thank You',
    description: 'Thank you for subscribing to Lyovson.com! Your subscription has been confirmed.',
    type: 'website',
