...
export default async function PrivacyPolicy() {
  ...
  return (
    <article className="prose prose-invert g3:col-start-2 g3:col-end-4 mx-auto max-w-4xl space-y-8 p-6">
      ...
      <section>
        ...
        <p>
          At <strong>Lyovson.com</strong>, we are committed to protecting your
          privacy and ensuring transparency about how we collect, use, and share
          your information. This Privacy Policy explains what data we collect,
      ...
      <section>
        ...
        <ul>
          <li>
            <strong>When You Sign Up:</strong> Name, email address, and other
            registration details.
          </li>
          <li>
            <strong>When You Contact Us:</strong> Information you provide via
        ...
        <ul>
          <li>
            <strong>Google Analytics:</strong> For understanding site usage and
      ...
      <section>
        ...
        <ul>
          <li>
            <strong>Site Improvement:</strong> To understand how users interact
            with our content.
          </li>
          <li>
          ...
          <li>
            <strong>Communication:</strong> To respond to inquiries or provide
            updates.
          </li>
          <li>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            <strong>Opt-Out</strong> of the sale of your personal data (we do
            not sell data)
          </li>
        </ul>
      ...
      <section>
        ...
        <p>
          You can manage your cookie preferences via the Cookie Consent Banner
          on our site or through your browser settings.
        </p>
        <ul>
          <li>
          ...
          <li>
            <strong>Manage Cookies:</strong> Adjust your settings in our Cookie
            Preferences modal.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          posted on this page with an updated &ldquo;Effective Date.&rdquo;
        </p>
      </section>
