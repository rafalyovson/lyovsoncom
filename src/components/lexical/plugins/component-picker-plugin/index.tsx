...
import { BlockTypes } from '@/data/misc/block-types';
import { EmbedConfigs } from '@/data/misc/embed-configs';
import { useDialog } from '@/lib/hooks/use-dialog';
import { InsertImageDialog } from '../images-plugin';

class ComponentPickerOption extends MenuOption {
  // What shows up in the lexical
  title: string;
  // Icon for display
  icon?: ReactNode;
  // For extra searching.
...
export const ComponentPickerPlugin = (): ReactNode => {
