...
export const GridCardHeader = async ({ className }: { className?: string }) => {
  return (
    <GridCard className={`col-start-1 col-end-2 row-start-1 row-end-2 ${className}`}>
      <Link
        className={`border row-start-1 row-end-3 col-start-1 col-end-4 flex flex-col justify-center items-center p-2 bg-linear-to-r from-[#f0f0f0] to-[#e0e0e0] dark:from-[#1c1c1e] dark:to-[#121212] rounded-lg shadow-md hover:shadow-lg `}
        href="/"
      >
