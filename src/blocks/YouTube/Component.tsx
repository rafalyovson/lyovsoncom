...
const PlayButton = () => (
  <div className="group/play absolute inset-0 flex items-center justify-center z-20">
    <div className="relative">
      <div className="w-20 h-20 bg-background/90 backdrop-blur-xs rounded-full border border-border shadow-lg flex items-center justify-center transition-all duration-300 group-hover/play:scale-105 group-hover/play:bg-primary">
      ...
      >
        {!isLoaded ? (
          <button
            ...
            className="w-full h-full relative block focus:outline-hidden focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
